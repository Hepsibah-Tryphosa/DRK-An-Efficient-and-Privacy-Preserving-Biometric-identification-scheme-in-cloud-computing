    ...
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          ...
          <form action="o_InsertDataAction" method="post" id="sendemail" enctype="multipart/form-data">
            <ol>
              <li class="style7">
			  ...
			  <li>
                <span class="style7">
                <label for="pic"><span class="style2">Select Profile Image </span> (required)</label>
