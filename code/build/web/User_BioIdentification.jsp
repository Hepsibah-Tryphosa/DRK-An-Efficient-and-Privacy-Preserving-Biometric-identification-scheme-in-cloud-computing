...
<head>
<title>User Biometric Identification</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <h2 class="style5">User Biometric Identication!!!</h2>
          <p>&nbsp;</p>
          <div class="clr"></div>
          ...
          <p>
              ...
              <form action="UBioIdentiryAction" method="post" id="sendemail" enctype="multipart/form-data">
            <ol><li><ol><ol><ol>
