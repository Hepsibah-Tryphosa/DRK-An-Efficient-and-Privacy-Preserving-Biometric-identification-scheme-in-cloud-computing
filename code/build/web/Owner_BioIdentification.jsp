...
<head>
<title>Owner Biometric Identification</title>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <h2 class="style5">Owner Biometric Identication!!!</h2>
          <p>&nbsp;</p>
          <div class="clr"></div>
          ...
          <p>
              <!--<form action="OBioIdentiry.jsp" method="post" id="sendemail" enctype="multipart/form-data">-->
                  <form action="OBioIdentiryAction" method="post" id="sendemail" enctype="multipart/form-data">
            <ol><li><ol><ol><ol>
