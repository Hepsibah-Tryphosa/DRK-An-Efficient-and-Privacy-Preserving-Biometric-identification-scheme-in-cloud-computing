  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        ...
        <div class="article">
          <h2 class="style5">Unauthorized Consumer <%=(String)session.getAttribute("consumer")%> Please Wait for Server Permission.</h2>
          <p>&nbsp;</p>
          <div class="clr"></div>
      ...
      <div class="sidebar">
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="#">Search Biometric Image Files</a></li>
			<li><a href="#">Download Biometric Image Files</a></li>
